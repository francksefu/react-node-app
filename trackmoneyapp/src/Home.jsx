  ...
  Chart.register(CategoryScale);
    ...
    return (
      <section className="mx-auto p-2 content-center">
        ...
        <div className="grid grid-cols-3 content-center p-3">
          <div className="max-w-sm animate-bounce hover:animate-none p-6 bg-gray-300 border border-green-200 rounded-lg shadow-lg ">
