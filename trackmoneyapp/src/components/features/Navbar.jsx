    ...
    return (
        ...
        <nav className="bg-gray-800">
            <div className="mx-auto max-w-7xl px-2 sm:px-6 lg:px-8">
                ...
                <div className="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
                    ...
                    <div className="flex space-x-4">
                        ...
                        <Link to="/" className="rounded-md px-3 py-2 text-sm font-medium text-gray-300 hover:bg-gray-700 hover:text-white">Expenses</Link>
            ...
            <div className="sm:hidden" id="mobile-menu">
                ...
                <Link to="#" className="block rounded-md px-3 py-2 text-base font-medium text-gray-300 hover:bg-gray-700 hover:text-white">Expenses</Link>
                <Link to="#" className="block rounded-md px-3 py-2 text-base font-medium text-gray-300 hover:bg-gray-700 hover:text-white">Categories</Link>
                </div>
            </div>
            </nav>
        </>
